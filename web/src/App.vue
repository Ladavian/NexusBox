...
const handleResize = () => {
  ...
  if ((lastWidth >= 768 && currentWidth < 768) || (lastWidth < 768 && currentWidth >= 768)) {
    if (currentWidth < 768) {
      ...
      // 切换到桌面端：恢复用户的折叠历史设置
      globalStore.isSidebarCollapsed = localStorage.getItem('nexusbox-sidebar-collapsed') === 'true'
    }
  }
...
onMounted(async () => {
  ...
  try {
    ...
    if (resp.ok) {
      const data = await resp.json()
      globalStore.isAuthenticated = data.authenticated
    }
  } catch (_) {
    globalStore.isAuthenticated = false
  }
  globalStore.authChecked = true
...
<template>
  <!-- 未登录时显示登录页 -->
  <Login v-if="globalStore.authChecked && !globalStore.isAuthenticated" />
  
  <!-- 已登录后显示主界面 -->
  <div v-else-if="globalStore.authChecked && globalStore.isAuthenticated" class="flex h-screen w-screen overflow-hidden bg-[#f1f5f9] dark:bg-[#0f172a] transition-colors duration-200 relative">
      ...
      <div class="flex items-center p-4 border-b border-slate-100 dark:border-slate-800/60 w-full transition-all duration-300 justify-between">
        ...
        <div class="flex items-center select-none cursor-pointer group/logo"
          ...
          <div class="w-8 h-8 flex items-center justify-center shrink-0 transition-transform duration-500 text-accent"
            ...
            <img src="data:image/svg+xml;base64," class="w-8 h-8" alt="NexusBox" />
          </div>
          <!-- 标题，随折叠平滑收缩 -->
